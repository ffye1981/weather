    ...
    export default {
          ...
          //       max:229.99658},
              ...
              heatCfg: {
                ...
                gradient: {
                  ...
                  // 0.0645: "rgb(180,0,35)",
                  0.0645: "rgb(255,0,0)",
                  0.1985: "rgb(212,79,63)",
                  0.4665: "rgb(255,208,127)",
                  0.6005: "rgb(255,242,187)",
                  1: "rgb(255,255,255)",
                  // 0.7345: "rgb(198,231,181)",
                  // 0.8015: "rgb(151,218,168 )",
                  // 1: "rgb(128,205,193 )",
                  // 1: "rgb(60,157, 194)",
                  // 1: "rgb(36,104, 180)",
                },
        ...
        methods: {
            ...
            getData(hour) {
                ...
                this.$http.getData(config.services.baseUrl + weatherNameData[this.weatherType] + "/findOneGrib", {refTime: this.playTime, surfaceValue: 0 * 100}, {}, function (data, msg) {
            ...
            updateLegend: function (data) {
              ...
              this.$store.dispatch('ACTION_WEATHER_LEGEND', {
                ...
                max: ((data.max) / 1000 ).toFixed(1),       //最大值
                min: ((data.min) / 1000 ).toFixed(1),       //最小值
                unit: 'km'      //单位
              })
            }
        },
